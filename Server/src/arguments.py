...
class ArgumentHandler:
	...
	def __define_arguments(self):
		group = self.__parser.add_mutually_exclusive_group(required=False)
		...
		self.__parser.add_argument("-a", metavar="alg", type=str, help="algorithm to be used", required=False, choices=["clahe", "um", "hef"])
